...
a.items.push(Item.find(1), Item.find(2))
...
b.items.push(Item.find(3), Item.find(4), Item.find(5))

c = Ritual.create(
  name: "Enlarged Pores Help",
  description: "A good exfoliator and charcoal mask can considerably help clean out the gunk in pores to keep them from clogging.",
  category: "Pore Minimizing"
)
c.items.push(Item.find(6),Item.find(7))
